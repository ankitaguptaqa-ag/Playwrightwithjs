...
```ts
  ...
  229 |             await this.addExpense.singleExpenseHeading.click(); // click outside to close the dropdown
  230 |             return;
  231 |         }
  ...
  248 | 
  249 |         if (isEmpty) {
  250 |             await this.addExpense.singleExpenseHeading.click(); // click outside to close the dropdown
  251 |             return;
  252 |         }
  253 | 
