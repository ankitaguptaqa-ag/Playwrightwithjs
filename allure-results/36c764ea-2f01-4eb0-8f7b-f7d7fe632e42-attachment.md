...
Call log:
  - waiting for locator('in-payee-management-button').first()
    - locator resolved to <in-payee-management-button _nghost-qfj-c358="" _ngcontent-qfj-c362="">…</in-payee-management-button>
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      - element is visible, enabled and stable
      - scrolling into view if needed
      - done scrolling
      - <in-loader _ngcontent-qfj-c369="" class="tw-w-full tw-overflow-auto laptop:!tw-w-[700px] tw-flex tw-items-center tw-justify-center tw-h-[calc(100vh-60px)] ng-star-inserted">…</in-loader> from <in-edit-payee _nghost-qfj-c369="" class="ng-star-inserted">…</in-edit-payee> subtree intercepts pointer events
  ...
  - retrying click action
    ...
    - scrolling into view if needed
    - done scrolling
    - <div _ngcontent-qfj-c282="" class="tw-fixed tw-bg-[rgba(24,44,74,0.45)] tw-inset-0 tw-w-full tw-h-full tw-top-0 tw-left-0 ng-tns-c282-6"></div> from <in-edit-payee _nghost-qfj-c369="" class="ng-star-inserted">…</in-edit-payee> subtree intercepts pointer events
  - retrying click action
    - waiting 500ms
    - waiting for element to be visible, enabled and stable
    - element is visible, enabled and stable
    - scrolling into view if needed
    - done scrolling
    - <div _ngcontent-qfj-c282="" class="tw-fixed tw-bg-[rgba(24,44,74,0.45)] tw-inset-0 tw-w-full tw-h-full tw-top-0 tw-left-0 ng-tns-c282-8"></div> from <in-manage-payee class="ng-star-inserted">…</in-manage-payee> subtree intercepts pointer events
