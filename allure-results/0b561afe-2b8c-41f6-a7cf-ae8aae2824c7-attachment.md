...
Call log:
  - waiting for locator('//ng-select[@formcontrolname="StateId"]//span[@class="ng-arrow"]')
    - locator resolved to <span class="ng-arrow"></span>
  ...
  2 × retrying click action
      ...
      - done scrolling
      - <span class="ng-arrow-wrapper">…</span> intercepts pointer events
...
> 144 |         await this.addAdditionalInfoButton.stateArrow.click();
      |                                                       ^ TimeoutError: locator.click: Timeout 15000ms exceeded.
