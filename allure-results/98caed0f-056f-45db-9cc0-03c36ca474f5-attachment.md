...
Call log:
  - waiting for locator('//span[contains(text()," Add Expense")]') to be visible
    - waiting for" https://qa-auth.innago.com/login?logout=true" navigation to finish...
    - navigated to "https://qa-auth.innago.com/login?logout=true"
...
> 45  |             .waitFor({ state: 'visible', timeout: 30000 });
  ...
  140 | 
  141 | 
  142 |     async navigateToReportsPage() {
  143 |         await this.reports.click();
