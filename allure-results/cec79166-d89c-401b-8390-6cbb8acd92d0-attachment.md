...
Call log:
  ...
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      ...
      - done scrolling
      - <div _ngcontent-wqj-c282="" class="tw-fixed tw-bg-[rgba(24,44,74,0.45)] tw-inset-0 tw-w-full tw-h-full tw-top-0 tw-left-0 ng-tns-c282-8"></div> from <div class="content-wrapper">…</div> subtree intercepts pointer events
