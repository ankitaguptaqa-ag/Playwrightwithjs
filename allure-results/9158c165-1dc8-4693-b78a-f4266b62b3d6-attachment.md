...
Call log:
  ...
  - waiting for locator('div[aria-controls="dropdown-term"]')
    24 × locator resolved to <div disabled="true" dropdowntoggle="" aria-haspopup="true" aria-expanded="false" _ngcontent-mcf-c286="" aria-controls="dropdown-term" class="innago-multiselect-field">…</div>
