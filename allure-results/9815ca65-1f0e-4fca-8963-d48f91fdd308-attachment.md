...
Error: locator.waitFor: Error: strict mode violation: locator('tbody>tr>td:nth-of-type(2)>div>p') resolved to 2 elements:
    1) <p inapplyhighlight="" _ngcontent-eyr-c283="" data-locator="listingPropertyName" class="font-600 m-0 color-dark text-break">Online Lease Oak Street</p> aka getByText('Online Lease Oak Street').first()
    2) <p inapplyhighlight="" _ngcontent-eyr-c283="" data-locator="listingPropertyName" class="font-600 m-0 color-dark text-break">Online Lease Oak Street</p> aka getByText('Online Lease Oak Street').nth(1)
